"""
数独棋盘解析器模块，用于将各种格式的数独字符串转换为程序内部表示

支持的格式：
- 紧凑格式数独棋盘：无空格分隔的字符串，如"030007004..."
- 带空格格式数独棋盘：数字之间用空格分隔的字符串，如"0 3 0 0 0 7 0 0 4..."
- 紧凑格式温度计：无空格分隔的坐标字符串，形如"A1B1B2"
- 带空格格式温度计：坐标之间用空格分隔的字符串，形如"B7 B8 B9 B10"
"""
