...
class NonConsecutiveRule(Rule):
    ...
    def is_valid(self, board: Board) -> bool:
        ...
        for i in range(size):
            for j in range(size):
                current_digit = board.get_digit(i, j)
